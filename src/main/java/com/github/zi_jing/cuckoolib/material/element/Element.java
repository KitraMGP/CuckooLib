package com.github.zi_jing.cuckoolib.material.element;
...
public enum Element {
	...
	Db("Dubnium"      , 105, 157),
	Sg("Seaborgium"   , 106, 156),
	Bh("Bohrium"      , 107, 157),
	Hs("Hassium"      , 108, 161),
	Mt("Meitnerium"   , 109, 159),
	Ds("Darmstadtium" , 110, 171),
	Rg("Roentgenium"  , 111, 170),
	Cn("Copernicium"  , 112, 173),
	Nh("Nihonium"     , 113, 173),
	Fl("Flerovium"    , 114, 173),
	Mc("Moscovium"    , 115, 173),
	Lv("Livermorium"  , 116, 175),
