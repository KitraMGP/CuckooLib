...
public abstract class Material {
  public static final SizeLimitedRegistry<String, Material> REGISTRY =
      new SizeLimitedRegistry<String, Material>(1024);

  public static final Map<Class<? extends Material>, Long> DEFAULT_FLAGS =
      new HashMap<Class<? extends Material>, Long>();
