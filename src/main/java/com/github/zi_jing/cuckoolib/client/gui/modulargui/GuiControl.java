...
public class GuiControl {
    ...
    public static class ControlFactory {
        ...
        public Button createButton(int width, int height, int u, int v, int u2, int v2, Consumer<ModularGuiScreen> onClick) {
    ...
    public static class Button extends GuiControl {
        ...
        protected Button(int id, int width, int height, int u, int v, int u2, int v2, Consumer<ModularGuiScreen> onClick, ModularGuiScreen gui) {
