...
public class GLUtil {
    ...
    static {
        ...
        try {
            ...
            System.out.println("CuckooLib: Warning: If you are running JUnit tests, you can ignore this warning.");
        }
    }
     ...
     * 示例:<br>
     * &emsp;&emsp;
     * <code>rgbToHex(102, 204, 255) = 0x66CCFF</code>
     *
     * @see #hexRGBToRGB(int)
     */
     ...
     *
     * @param hex 像"3FFF3F"、"3fff3f"、"3FfF3f"这样的字符串。它也支持以'#'开头的字符串<br><br>
     ...
     * @see #drawScaledCenteredStringWithShadow(MatrixStack, String, float, float, int, int)
     */
    ...
    /**
     * 用于绘制原版Gui在世界中的暗灰色半透明背景, 通常需要在{@link Screen#render(MatrixStack, int, int, float)}的开头调用。
     *
    ...
    /**
     * 用于绘制原版Gui不再在世界中时的泥土背景, 通常需要在{@link Screen#render(MatrixStack, int, int, float)}的开头调用。
     *
    ...
    public static void fill(MatrixStack matrixStack, int x, int y, int width, int height, int color) {
        ...
        bufferBuilder.pos(matrix4f, x, y + height, 0).color(renderStateR, renderStateG, renderStateB, renderStateA).endVertex();
        bufferBuilder.pos(matrix4f, x + width, y + height, 0).color(renderStateR, renderStateG, renderStateB, renderStateA).endVertex();
        bufferBuilder.pos(matrix4f, x + width, y, 0).color(renderStateR, renderStateG, renderStateB, renderStateA).endVertex();
     ...
     *
     * @see #drawTexturedRect(MatrixStack, int, int, int, int, int, int, ResourceLocation)
     ...
     * @see #drawTexturedRectWithCustomSizedTexture(MatrixStack, int, int, int, int, int, int, int, int, int, int)
     * @see #drawTexturedRectWithCustomSizedTexture(MatrixStack, int, int, int, int, int, int, int, int, int, int, ResourceLocation)
     * @see #drawTexturedRectWithCustomSizedTextureWithDefaultUV(MatrixStack, int, int, int, int, int, int, int, int)
     * @see #drawTexturedRectWithCustomSizedTextureWithDefaultUV(MatrixStack, int, int, int, int, int, int, int, int, ResourceLocation)
     */
    public static void drawTexturedRect(MatrixStack matrixStack, int x, int y, int u, int v, int width, int height) {
        ...
        bufferBuilder.pos(matrix4f, x + width, y + height, 0).tex((float) (m * (u + width)), (float) (m * (v + height))).endVertex();
     ...
     */
    public static void drawTexturedRect(MatrixStack matrixStack, int x, int y, int u, int v, int width, int height, ResourceLocation textureLocation) {
     ...
     * @see #drawTexturedRect(MatrixStack, int, int, int, int, int, int)
     */
    public static void drawTexturedRectWithDefaultUV(MatrixStack matrixStack, int x, int y, int width, int height, ResourceLocation textureLocation) {
        bindTexture(textureLocation);
        drawTexturedRect(matrixStack, x, y, 0, 0, width, height);
    }
     ...
     * @see #drawTexturedRectWithCustomSizedTextureWithDefaultUV(MatrixStack, int, int, int, int, int, int, int, int, ResourceLocation)
     */
    public static void drawTexturedRectWithCustomSizedTexture(MatrixStack matrixStack, int x, int y, int u, int v, int width, int height, int drawWidth, int drawHeight, int textureWidth, int textureHeight) {
        preRenderTexture();
        ...
        bufferBuilder.pos(matrix4f, x + width, y + height, 0).tex((float) (mw * (u + width)), (float) (mh * (v + height))).endVertex();
     ...
     */
    public static void drawTexturedRectWithCustomSizedTexture(MatrixStack matrixStack, int x, int y, int u, int v, int width, int height, int drawWidth, int drawHeight, int textureWidth, int textureHeight, ResourceLocation textureLocation) {
        bindTexture(textureLocation);
        drawTexturedRectWithCustomSizedTexture(matrixStack, x, y, u, v, width, height, drawWidth, drawHeight, textureWidth, textureHeight);
    }
     ...
     * UV为0, 即总是从贴图左上角开始绘制。
     */
    public static void drawTexturedRectWithCustomSizedTextureWithDefaultUV(MatrixStack matrixStack, int x, int y, int width, int height, int drawWidth, int drawHeight, int textureWidth, int textureHeight) {
        drawTexturedRectWithCustomSizedTexture(matrixStack, x, y, 0, 0, width, height, drawWidth, drawHeight, textureWidth, textureHeight);
    }
     ...
     * UV为0, 即总是从贴图左上角开始绘制。
     */
    public static void drawTexturedRectWithCustomSizedTextureWithDefaultUV(MatrixStack matrixStack, int x, int y, int width, int height, int drawWidth, int drawHeight, int textureWidth, int textureHeight, ResourceLocation textureLocation) {
        bindTexture(textureLocation);
        drawTexturedRectWithCustomSizedTexture(matrixStack, x, y, 0, 0, width, height, drawWidth, drawHeight, textureWidth, textureHeight);
    }
