...
public class ModularGuiScreen extends GuiScreen implements IModularGui {
	...
	public ModularGuiScreen(int type) {
		...
		this.forceChangeGuiScale = (type & ModularGuiConstants.GUI_FORCE_CHANGE_SCALE) == ModularGuiConstants.GUI_FORCE_CHANGE_SCALE;
		this.hasCustomBackground = (type & ModularGuiConstants.GUI_HAS_CUSTOM_BACKGROUND) == ModularGuiConstants.GUI_HAS_CUSTOM_BACKGROUND;
		this.doesGuiPauseGame = (type & ModularGuiConstants.GUI_NOT_PAUSE_GAME) != ModularGuiConstants.GUI_NOT_PAUSE_GAME;
