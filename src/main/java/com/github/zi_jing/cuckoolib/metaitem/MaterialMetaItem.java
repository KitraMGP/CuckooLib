...
public class MaterialMetaItem extends MetaItem<MetaValueItem> {
	...
	public void registerItemModel() {
		this.solidShapeMap.forEachEntry((id, shape) -> {
			ModelBakery.registerItemVariants(this,
					new ResourceLocation(CuckooLib.MODID, "metaitem/material/" + shape.getName()));
			return true;
		});
		ModelLoader.setCustomMeshDefinition(this, (stack) -> {
			...
			return new ModelResourceLocation(
					new ResourceLocation(CuckooLib.MODID, "metaitem/material/" + shape.getName()), "inventory");
		});
	}
